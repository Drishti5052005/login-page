...
public class page5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h3><a href=page2>click to visit page 2</a></h3>");
            out.println("<h3><a href=page3>click to visit page 3</a></h3>");
            out.println("<h3><a href=page4>click to visit page 4</a></h3>");
            out.println("</body>");
            out.println("</html>");
        }
    }
